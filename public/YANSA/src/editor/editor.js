        ...
        .then(res => {
          ...
          fetch(
            "/userRating/" +
              noteTitle +
              "-" +
              sessionStorage.getItem("noteAuthor"),
            {
              method: "GET",
              headers: {
                "content-type": "application/json",
    ...
    editor.save().then(data => {
      ...
      if (check) {
        fetch("/savenote/new", {
          ...
          body: JSON.stringify({
            title: document.getElementById("titolo_eff").innerText,
          ...
          .then(res => {
            ...
            sessionStorage.setItem(
              "noteName",
              document.getElementById("titolo_eff").innerText
            );
            window.location.reload();
          })
          .then(() => {
            fetch(
              "/addCategory/" + document.getElementById("titolo_eff").innerText,
              {
                method: "POST",
                headers: {
                  "content-type": "application/json",
...
if (
  ...
  (sessionStorage.getItem("noteName") === null &&
