window.onload = async () => {
    if (sessionStorage.getItem("token") !== null) {
        await render(document.getElementById("noteContainer"), document.getElementById("pencil"), await prendiAppunti(await pickData("/userFeed")));
    } else {
...
document.getElementById("pigliaCatFeed").onclick = async () => {
    ...
    await render(document.getElementById("noteContainer"), document.getElementById("pencil"), await prendiAppunti(await categoryFeed(catSelezionate)));
};
